...
(defun orgraphy--faces ()
  ...
  (orgraphy--set-face-attribute 'org-document-title nil :height 2.2 :inherit 'variable-pitch :weight 'normal)
  ...
  (orgraphy--set-face-attribute 'markdown-header-face-1 nil :inherit 'outline-1)
  (orgraphy--set-face-attribute 'outline-2 nil :height 1.6 :inherit 'variable-pitch :weight 'normal)
  (orgraphy--set-face-attribute 'markdown-header-face-2 nil :inherit 'outline-2)
  (orgraphy--set-face-attribute 'outline-3 nil :height 1.4 :inherit 'variable-pitch :weight 'normal)
  (orgraphy--set-face-attribute 'markdown-header-face-3 nil :inherit 'outline-3)
  (orgraphy--set-face-attribute 'outline-4 nil :height 1.2 :inherit 'variable-pitch :weight 'normal)
  (orgraphy--set-face-attribute 'markdown-header-face-4 nil :inherit 'outline-4)
  (orgraphy--set-face-attribute 'outline-5 nil :height 1.0 :inherit 'variable-pitch :weight 'normal :slant 'italic)
  (orgraphy--set-face-attribute 'markdown-header-face-5 nil :inherit 'outline-5)
  (orgraphy--set-face-attribute 'outline-6 nil :height 1.0 :inherit 'variable-pitch :weight 'normal :slant 'italic)
  (orgraphy--set-face-attribute 'markdown-header-face-6 nil :inherit 'outline-6)
  (orgraphy--set-face-attribute 'outline-7 nil :height 1.0 :inherit 'variable-pitch :weight 'normal :slant 'italic)
  (orgraphy--set-face-attribute 'outline-8 nil :height 1.0 :inherit 'variable-pitch :weight 'normal :slant 'italic)
