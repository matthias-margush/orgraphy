...
(defun orgraphy--faces ()
  ...
  (orgraphy--set-face-attribute 'org-document-title nil :height 2.4 :inherit 'variable-pitch :weight 'normal)
  ...
  (orgraphy--set-face-attribute 'outline-1 nil :height 2.5 :inherit 'variable-pitch :weight 'normal)
  (orgraphy--set-face-attribute 'outline-2 nil :height 2.0 :inherit 'variable-pitch :weight 'normal)
  (orgraphy--set-face-attribute 'outline-3 nil :height 1.75 :inherit 'variable-pitch :weight 'normal)
  (orgraphy--set-face-attribute 'outline-4 nil :height 1.5 :inherit 'variable-pitch :weight 'normal)
  (orgraphy--set-face-attribute 'outline-5 nil :height 1.25 :inherit 'variable-pitch :weight 'normal)
